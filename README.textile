This has been modified to work with DataMapper on Rails3.
Instructions are the same except for the ActiveRecord setup.
...
Keep in mind that each worker will check the database at least every 60 seconds.
